...
public class ConsumerExample {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    props.put(KafkaJsonDeserializerConfig.JSON_VALUE_TYPE, Long.class);
    ...
    try {
      while (true) {
        ...
        for (ConsumerRecord<String, Long> record : records) {
          ...
          System.out.printf("Consumed record with key %s, delay of %f milliseconds\n", key, delayInMs);
        }
      }
    } finally {
      consumer.close();
